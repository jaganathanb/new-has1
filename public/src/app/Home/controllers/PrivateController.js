define(['utils', 'sns'], function(utils, SocketNamespace) {
    var PrivateController = function($rootScope, $location) {
    ...
    PrivateController.prototype.addListeners = function() {
        var that = this;
    ...
    PrivateController.prototype.connectToServer = function(name) {
        var that = this;
        this.name = name;
    ...
    PrivateController.prototype.createRoom = function(roomName, namespace) {
        var that = this;
        this.show = false;
    ...
    PrivateController.prototype.joinRoom = function(roomName, namespace) {
        this.this.socketNamespaces[namespace].emit('join-room', roomName);
    }

    PrivateController.prototype.leaveRoom = function(roomName, namespace) {
        var that = this;
        this.socketNamespaces[namespace].emit('leave-room', roomName);
    }

    PrivateController.prototype.getRooms = function(namespace) {
        var that = this;
        this.socketNamespaces[namespace].emit('get-rooms');
    }

    PrivateController.prototype.send = function(namespace) {
        var that = this;
